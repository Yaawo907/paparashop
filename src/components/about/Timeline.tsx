...
const STORY = [
  ...
  },
  {
    ...
    text: "PaparaShop s'implante au Togo, consolidant sa position de seule boutique spécialisée et crédible d'Afrique de l'Ouest francophone en EQUIPEMENTIER AUDIOVISUEL professionnel.",
  },
];
