  ...
  head: () => ({
    meta: [
      { title: "À propos — PaparaShop | Depuis 2017 au Bénin, Burkina & Togo" },
      {
        name: "description",
        content:
          "Depuis 2017, PaparaShop est la seule boutique spécialisée d'Afrique de l'Ouest francophone en EQUIPEMENTIER AUDIOVISUEL professionnel. Bénin, Burkina Faso et Togo.",
      },
